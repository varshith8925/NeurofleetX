// frontend/src/pages/fleetmanager/VehicleManagement.jsx
import React, { useState, useEffect } from 'react';
import DashboardLayout from '../../components/common/DashboardLayout';
import DataTable from '../../components/common/DataTable';
import Modal from '../../components/common/Modal';
import Loading from '../../components/common/Loading';
import { Plus, Edit, Trash2, Car, Wrench } from 'lucide-react';
...
const VehicleManagement = () => {
  ...
  const handleSendToMaintenance = async (vehicle) => {
    try {
      await vehicleService.updateVehicle(vehicle.id, { ...vehicle, status: 'MAINTENANCE' });
  ...
  const actions = (row) => (
    <div className="flex items-center space-x-2">
      ...
      {row.status !== 'MAINTENANCE' && (
        <button
          onClick={() => handleSendToMaintenance(row)}
